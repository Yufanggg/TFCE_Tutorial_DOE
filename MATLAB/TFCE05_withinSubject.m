...
%
% Permutation:
%   Flip condition labels within each subject
%% ==========================================================
...
if nRows ~= nSubj * 2
    error('Expected exactly two rows per subject: Control and Treatment.');
end
...
%% ==========================================================
% Long-format variables for fitlme
%% ==========================================================
...
for ch = 1:nChan
    for tpoint = 1:nTime
        ...
        tbl = table(EEG, Condition, SubjectLME, ...
...
%% ==========================================================
% Step 3: Permutation by flipping condition labels within subject
%% ==========================================================

nPerm = 999;
TFCE_permMax = nan(nPerm,1);

fprintf('Step 3: Starting within-subject condition-label flipping: %d permutations...\n', nPerm);
...
parfor p = 1:nPerm
    ...
    for s = 1:nSubj
        ...
        idxSubj = find(Subject == subj);

        if rand > 0.5
            CondCode_perm(idxSubj) = flipud(CondCode_perm(idxSubj));
        end
    ...
    for ch = 1:nChan
        for tpoint = 1:nTime
            ...
            tbl = table(EEG, Condition_perm, SubjectLME, ...
                'VariableNames', {'EEG','Condition','Subject'});
...
Results.permutation  = 'Within-subject condition-label flipping';
Results.times        = times;
Results.e_loc        = e_loc;
