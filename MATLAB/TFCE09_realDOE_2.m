...
parfor p = 1:nPerm
    ...
    TFCE_permMax(p) = max(abs(TFCE_perm(:, 1:180)), [], 'all');
...
save('../Results/09_realDOE_results_2.mat',...
    'Results',...
    'nChan',...
    'time',...
    'channelinfo');
...
% 
% load('../Results/09_realDOE_results_2.mat')
...
imagesc(time,1:nChan,Results.P_Values < 0.25);
